...
wget raw.githubusercontent.com/Diah082/newbie/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
wget https://raw.githubusercontent.com/Diah082/newbie/main/Cfg/m-noobz 
